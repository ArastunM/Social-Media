...
public interface MiniSocialMediaPlatform extends Serializable {
	 ...
	 * @throws socialmedia.exceptions.IllegalHandleException if the handle already exists in the platform.
	 * @throws socialmedia.exceptions.InvalidHandleException if the new handle is empty, has more than 30
	 ...
	 * @throws socialmedia.exceptions.AccountIDNotRecognisedException if the ID does not match to any
	 ...
	 * @throws socialmedia.exceptions.HandleNotRecognisedException if the old handle does not match to any
	 *                                      account in the system.
	 * @throws socialmedia.exceptions.IllegalHandleException       if the new handle already exists in the
	 *                                      platform.
	 * @throws socialmedia.exceptions.InvalidHandleException       if the new handle is empty, has more
	 ...
	 * @throws socialmedia.exceptions.HandleNotRecognisedException if the handle does not match to any
	 *                                      account in the system.
	 */
	 ...
	 * @throws socialmedia.exceptions.HandleNotRecognisedException if the handle does not match to any
	 *                                      account in the system.
	 * @throws socialmedia.exceptions.InvalidPostException         if the message is empty or has more than
	 *                                      100 characters.
	 ...
	 * @throws socialmedia.exceptions.HandleNotRecognisedException if the handle does not match to any
	 *                                      account in the system.
	 * @throws socialmedia.exceptions.PostIDNotRecognisedException if the ID does not match to any post in
	 *                                      the system.
	 * @throws socialmedia.exceptions.NotActionablePostException   if the ID refers to a endorsement post.
	 ...
	 * @throws socialmedia.exceptions.InvalidPostException         if the comment message is empty or has
	 ...
	 * @throws socialmedia.exceptions.PostIDNotRecognisedException if the ID does not match to any post in
	 *                                      the system.
	 * @throws socialmedia.exceptions.NotActionablePostException   if the ID refers to an endorsement post.
